...
csv_path = "../../dataset2/Train_Test_IoT_GPS_Tracker.csv"

output_prefix = "../../dataset/gps/"
output_train = "../../dataset/gps/2b3-"
output_test = "../../dataset/gps/1b3-"
output_dataset = "../../dataset/gps/"
