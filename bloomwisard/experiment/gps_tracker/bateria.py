...
print("Dfx[latitude]:", df_x["latitude"].head(5))
print("Dfx[longitude]:", df_x["longitude"].head(5))
...
df_x['lat_diff'] = df_x['latitude'].diff().fillna(0)
df_x['lon_diff'] = df_x['longitude'].diff().fillna(0)
...
df_test_x['lat_diff'] = df_test_x['latitude'].diff().fillna(0)
df_test_x['lon_diff'] = df_test_x['longitude'].diff().fillna(0)
