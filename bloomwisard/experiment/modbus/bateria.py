...
df_x = pd.read_csv(
    ...
    header=None,
    usecols=[0, 1, 2, 3],
    names=["FC1_Read_Input_Register",
    "FC2_Read_Discrete_Value",
    "FC3_Read_Holding_Register",
    "FC4_Read_Coil"],
    dtype=float
)
print("Dfx[FC1_Read_Input_Register]:", df_x["FC1_Read_Input_Register"].head(5))
print("Dfx[FC2_Read_Discrete_Value]:", df_x["FC2_Read_Discrete_Value"].head(5))
print("Dfx[FC3_Read_Holding_Register]:", df_x["FC3_Read_Holding_Register"].head(5))
print("Dfx[FC4_Read_Coil]:", df_x["FC4_Read_Coil"].head(5))
