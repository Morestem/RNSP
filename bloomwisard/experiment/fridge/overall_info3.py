...
bits_encoding = 128   # Resolução alta para temperatura
...
df_x['term_diff'] = df_x['fridge_temperature'].diff().fillna(0)
#df_x['temp_ma'] = df_x['thermostat_status'].rolling(50).mean().fillna(0)
#df_x['temp_var'] = df_x['fridge_temperature'].rolling(70).var().fillna(0)
#df_x['temp_ma2'] = df_x['fridge_temperature'].rolling(500).mean().fillna(0)
#df_x['temp_var1'] = df_x['fridge_temperature'].rolling(500).var().fillna(0)
...
for fold, (train_idx, test_idx) in enumerate(kf.split(X)):
    ...
    for r in range(num_runs):
        ...
        print("Primeiros y_pred:", y_pred[:20])
        # metrics
