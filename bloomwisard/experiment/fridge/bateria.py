...
class GaussianThermometer:
    ...
    def __init__(self, mean, std, bits):
        ...
        # thresholds gaussianos
        probs = np.linspace(0, 1, bits + 2)[1:-1]

        self.thresholds = norm.ppf(
            probs,
            loc=self.mean,
            scale=self.std
        )
    ...
    def binarize(self, value):
        ...
        return value >= self.thresholds
    
# =========================================================
# DATASET
# =========================================================

base_path = "../../dataset/fridge/"
...
print("Dfx[fridge_temperature]:", df_x["fridge_temperature"].head(5))
print("Dfx[temp_condition]:", df_x["temp_condition"].head(5)) 

df_x["temp_t3"] = df_x["fridge_temperature"].shift(3)
df_x = df_x.fillna(0)
...
print("Dfx[fridge_temperature]:", df_test_x["fridge_temperature"].head(5))
print("Dfx[temp_condition]:", df_test_x["temp_condition"].head(5))

df_test_x["temp_t3"] = df_test_x["fridge_temperature"].shift(3)

df = df_test_x.fillna(0)
...
data_mean = np.mean(X_train_full, axis=0)
data_std = np.std(X_train_full, axis=0)
