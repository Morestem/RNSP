...
print("Dfx[temperature]:", df_x["temperature"].head(5))
print("Dfx[pressure]:", df_x["pressure"].head(5))
print("Dfx[humidity]:", df_x["humidity"].head(5))

#df_x['temperature_ma'] = df_x['temperature'].rolling(50).mean().fillna(0)
#df_x['pressure_ma'] = df_x['pressure'].rolling(70).mean().fillna(0)
#df_x['humidity_ma'] = df_x['humidity'].rolling(70).mean().fillna(0)
...
#df_test_x['temperature_ma'] = df_test_x['temperature'].rolling(50).mean().fillna(0)
#df_test_x['pressure_ma'] = df_test_x['pressure'].rolling(70).mean().fillna(0)
#df_test_x['humidity_ma'] = df_test_x['humidity'].rolling(70).mean().fillna(0)
