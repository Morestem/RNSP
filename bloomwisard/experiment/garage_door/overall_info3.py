...
bits_encoding = 3084   # Resolução alta para temperatura
...
df_x['temp_sphone_signal'] = df_x['sphone_signal'].rolling(500).mean().fillna(0)
df_x['temp_door_state'] = df_x['door_state'].rolling(500).var().fillna(0)
df_x['temp1_sphone_signal'] = df_x['sphone_signal'].rolling(100).mean().fillna(0)
df_x['temp1_door_state'] = df_x['door_state'].rolling(100).var().fillna(0)
