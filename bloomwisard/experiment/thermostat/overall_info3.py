...
bits_encoding = 2042   # Resolução alta para temperatura
...
#df_x['current_diff'] = df_x['current_temperature'].diff().fillna(0)
#df_x['term_diff'] = df_x['thermostat_status'].diff().fillna(0)
df_x['temp_ma'] = df_x['current_temperature'].rolling(50).mean().fillna(0)
df_x['temp_var'] = df_x['current_temperature'].rolling(70).var().fillna(0)
#df_x['temp_ma2'] = df_x['current_temperature'].rolling(500).mean().fillna(0)
#df_x['temp_var1'] = df_x['current_temperature'].rolling(500).var().fillna(0)
