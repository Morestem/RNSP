...
X = df_x.to_numpy(dtype=np.uint8)
y = df_y
...
X_final_test = df_test_x.to_numpy(dtype=np.uint8)
...
X_train_bin = X.astype(bool)
X_test_bin = X_final_test.astype(bool)
